...
class TestPreventDirectPublish(TestCase):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=True)
    def test_prevents_direct_publishing_when_disabled(self, direct_publishing_disabled: MagicMock):
        ...
        direct_publishing_disabled.assert_called_once_with()

    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    def test_allows_direct_publishing_when_enabled(self, direct_publishing_disabled: MagicMock):
...
class TestPreventBulkDirectPublish(TestCase):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=True)
    def test_prevents_bulk_publish_when_disabled(self, direct_publishing_disabled: MagicMock):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    def test_allows_bulk_publish_when_enabled(self, direct_publishing_disabled: MagicMock):
    ...
    def test_allows_other_bulk_actions_irrespectively(self):
        ...
        with patch(
            "cms.wagtail_hooks.direct_publishing_disabled", return_value=True
        ) as direct_publishing_disabled:
        ...
        with patch(
            "cms.wagtail_hooks.direct_publishing_disabled", return_value=False
        ) as direct_publishing_disabled:
            response = prevent_bulk_direct_publish(self.request, "delete", [self.page], self.action)
...
class TestRemoveNotAllowedActions(TestCase):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=True)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=False)
    def test_removes_publish_when_direct_publishing_disabled(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=False)
    def test_keeps_publish_when_direct_publishing_enabled(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=True)
    def test_removes_approve_and_reject_for_requester(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=True)
    def test_keeps_approve_and_reject_for_other_user(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=False)
    def test_keeps_approve_and_reject_when_self_approval_enabled(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=False)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=True)
    def test_keeps_approve_and_reject_without_workflow_state(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
    ...
    @patch("cms.wagtail_hooks.direct_publishing_disabled", return_value=True)
    @patch("cms.wagtail_hooks.self_approval_disabled", return_value=True)
    def test_removes_both_publish_and_approval_actions_for_requester(
        self, self_approval_disabled: MagicMock, direct_publishing_disabled: MagicMock
    ):
